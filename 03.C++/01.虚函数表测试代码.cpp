...
Base    -----------     ---------------------
        | vptr  --+---> | type-info         |
		-----------     ---------------------
		| int a   |     | address of ~Base()|
		-----------     ---------------------
		| int b   |     | address of func_2 |
		-----------     ---------------------
                        | address of func_3 |
                        ---------------------
*/
...
Base2   -----------     ---------------------
		...
		| int b   |     | address of func_2 |
		-----------     ---------------------
        | int c   |     | address of func_3 |
        -----------     ---------------------
        | int d   |     | address of func_4 |
        -----------     ---------------------
		                | address of func_5 |
                        ---------------------
*/
...
Base3   -----------     ---------------------
		...
		| int b   |     | address of func_2 |
		-----------     ---------------------
        | int c   |     | address of func_3 | (Base3)
        -----------     ---------------------
        | int d   |     | address of func_4 |
        -----------     ---------------------
		| int e   |     | address of func_5 |
        -----------     ---------------------
		| int f   |     | address of func_6 |
        -----------     ---------------------
*/
